...
#ifndef CH16_MULTIPLE_CATCH_TRIANGLE_H
#define CH16_MULTIPLE_CATCH_TRIANGLE_H
#include "Geometric_object.h"
#include  "Triangle_Exception.h"
#include <cmath>
#include "Non_Positive_Side_Exception.h"
...
private:
    ...
    bool is_valid(double side_1, double side_2, double side_3)const{
    ...
    void check_side(double side)const{

        if(side<=0)
            throw Non_Positive_Side_Exception(side) ;
...
#endif //CH16_MULTIPLE_CATCH_TRIANGLE_H
